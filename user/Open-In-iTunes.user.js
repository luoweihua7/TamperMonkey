...
setTimeout(() => {
    ...
    if (!document.querySelector('.product-header__routes')) {
        let domStr = `<div class="product-header__routes app-header__routes"><p class="product-header__routes__cta"><button aria-label="在 iTunes 中查看" class="we-button we-button--outlined we-button--external icon icon-external we-button-fade-in ember-view">在这里查看： <span class="we-button__app-text">iTunes </span></button></p></div>`;
